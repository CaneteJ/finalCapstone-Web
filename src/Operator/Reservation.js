...
const Reservation = () => {
  ...
  const HistoryLog = () => (
    <div className="history-log mt-4" style={{ maxHeight: '350px', maxWidth: '500px', overflowY: 'scroll' }}>
  ...
  const ReservationRequest = ({ request, index }) => (
    <div style = {{width: '40%', textAlign: 'center'}}className="reservation-request mb-4 border p-3 rounded bg-light" key={request.plateNumber}>
  ...
  return (
    ...
    <div>
      ...
      <div className="container mt-5 d-flex flex-column align-items-center justify-content-center">
        ...
        <div className="reservation-requests d-flex flex-column align-items-center mb-4" style={{ width: '80%', height:'60vh', overflowY: 'scroll', padding: '10px', background: "rgba(50, 55,55, 0.7)"}}>
        ...
        <h3 className="mb-3 mt-4 text-center text-white">Accepted/Declined Reservations</h3>
        <HistoryLog />
